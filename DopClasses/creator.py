...
def create_bone():
    ...
    dates=['2460189','2460335','2460511','2460701','2460865','2461066','2460865','2461431','2461595']
    for index in range (len(dates)-1):

        A.insert("semesters",{'id':f'{index+1}','start':f'{float(dates[index])}','stop':f'{float(dates[index+1])}'})
    courses={1:['Физическая культура и спорт', 
             ...
             5:['История России',
                ...
                'Проектное обучение',
                'Элективные дисциплины, (модули) по физической культуре'],
               6:['Основы научно-исследовательской деятельности',
                  'История России',
                  'Вычислительные системы и компьютерные сети',
                  ...
                  'Проектное обучение',
                  'Элективные дисциплины, (модули) по физической культуре'],
                7:['Психология социального взаимодействия, саморазвития и самоорганизации',
                   'Философия',
    ...
    for cur_key in list(courses.keys()):
        for cur_dis in courses[cur_key]:
            A.insert("disciplines",{"id":str(id),"name":cur_dis,"semester_id":str(cur_key)})
            id+=1
    ...
    pairs={1:"8:30",2:"10:10",3:"11:50",4:"13:50",5:"15:30",6:"17:10",7:"18:50"}
